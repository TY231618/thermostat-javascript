...
The challenge this week at Makers Academy was to build an interactive thermostat web app in JavaScript. The whole process was test driven using Jasmine.  I used jQuery to add interactive functionality and AJAX to make calls to external API's to find weather conditions from cities around the world.

Installation
-------
1. Clone this repo `$ git clone git@github.com:TY231618/thermostat-javascript.git`
2. Change directory into it `$ cd thermostat-javascript`
